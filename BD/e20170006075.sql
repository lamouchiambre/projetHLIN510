...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 05 déc. 2019 à 19:44
...
('3', '1', '1', 'la meteo en folie', '-1.00', '2019-12-19', '2019-12-19', '15:00:00', '17:00:00', NULL, '300', 'Un spectacle en folie avec plein de pluie', NULL, NULL);
...
(1, 'ATTENTION, LE ROLE DOIT ETRE BON', '2019-12-05 19:33:36'),
(2, 'ATTENTION, LE ROLE DOIT ETRE BON', '2019-12-05 19:34:21'),
(3, 'ATTENTION, LE ROLE DOIT ETRE BON', '2019-12-05 19:34:22'),
(4, 'ATTENTION, LE ROLE DOIT ETRE BON', '2019-12-05 19:34:42'),
(5, 'ATTENTION, LE ROLE DOIT ETRE BON', '2019-12-05 19:35:29'),
(6, 'ATTENTION, LE ROLE DOIT ETRE BON', '2019-12-05 19:38:07'),
(7, 'ATTENTION, LE ROLE DOIT ETRE BON', '2019-12-05 19:41:11'),
(8, 'ATTENTION, LE ROLE DOIT ETRE BON', '2019-12-05 19:41:48');
...
DELIMITER $$
CREATE TRIGGER `user_role_attribue` BEFORE INSERT ON `user` FOR EACH ROW IF NEW.us_role <> 'administrator' 
    OR NEW.us_role <> 'contributor' 
    OR NEW.us_role <> 'visitor'
    	THEN
